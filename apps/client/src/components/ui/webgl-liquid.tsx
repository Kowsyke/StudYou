...
import { WebGLErrorBoundary, WebGLFallback } from './webgl-liquid-utils/webgl-error-boundary'
...
void main() {
  ...
  float MathBand = smoothstep(0.62, 1.08, structure);
  vec3 col = mix(u_colorDeep, u_colorMid, lowBand);
  col = mix(col, u_colorHighlight, MathBand);
